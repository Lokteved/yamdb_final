# Generated by Django 3.0.5 on 2020-09-12 02:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Значение рейтинга, должно быть больше 1'), django.core.validators.MaxValueValidator(10, message='Значение рейтинга, должно быть меньше или равно 10')], verbose_name='Оценка')),
                ...
                ('title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='review', to='api.Title', verbose_name='Произведение')),
            ],
            options={
                'verbose_name': 'Отзыв',
